...
def match_yago_entity_from_yago(label_value_dict, file_subset):
    floder_path = 'freebase'
...
if __name__ == "__main__":
    with open("label_value.pkl", "rb") as f:
        label_value_dict = pickle.load(f)
    match_yago_entity_from_yago(label_value_dict, os.listdir('freebase'))
